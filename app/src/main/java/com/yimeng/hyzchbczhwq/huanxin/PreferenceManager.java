...
public class PreferenceManager {
    ...
    public String getUserNick(String username) {
        return mSharedPreferences.getString(username + "nick", username);
    }

    public void setUserNick(String username, String nick) {
        editor.putString(username + "nick", nick);
        editor.commit();
    }

    public String getUserAvatar(String username) {
        return mSharedPreferences.getString(username + "avatar", "");
    }

    public void setUserAvatar(String username, String avatar) {
        editor.putString(username + "avatar", avatar);
        editor.commit();
    }
}
