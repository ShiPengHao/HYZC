...
public class HuanXinDBManager {
    static private HuanXinDBManager dbMgr = new HuanXinDBManager();
    private DbOpenHelper dbHelper;
    
    private HuanXinDBManager(){
        dbHelper = DbOpenHelper.getInstance(MyApp.getAppContext().getApplicationContext());
    }
    
    public static synchronized HuanXinDBManager getInstance(){
        if(dbMgr == null){
            dbMgr = new HuanXinDBManager();
        }
        return dbMgr;
    }
