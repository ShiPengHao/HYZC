...
public class InviteMessgeDao {
	...
	public Integer saveMessage(InviteMessage message){
		return HuanXinDBManager.getInstance().saveMessage(message);
	}
	...
	public void updateMessage(int msgId,ContentValues values){
	    HuanXinDBManager.getInstance().updateMessage(msgId, values);
	}
	...
	public List<InviteMessage> getMessagesList(){
		return HuanXinDBManager.getInstance().getMessagesList();
	}
	
	public void deleteMessage(String from){
	    HuanXinDBManager.getInstance().deleteMessage(from);
	}
	
	public int getUnreadMessagesCount(){
	    return HuanXinDBManager.getInstance().getUnreadNotifyCount();
	}
	
	public void saveUnreadMessageCount(int count){
	    HuanXinDBManager.getInstance().setUnreadNotifyCount(count);
	}
}
